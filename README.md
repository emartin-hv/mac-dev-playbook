...
## Installation
  ...
  2. Enable Rosetta for M1 macs: `sudo softwareupdate --install-rosetta --agree-to-license`.
  3. Login to the Mac App Store app manually by launching `App Store.app` and signing in. (Note: Monterey still fails automatically installing MAS apps as of Oct 2022)
